...
# installed.
TCL_PREFIX='/opt/anaconda3/envs/mag-map'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/anaconda3/envs/mag-map'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /opt/anaconda3/envs/mag-map/include -fdebug-prefix-map=/var/folders/nz/j6p8yfhx1mv_0grj5xl4650h0000gp/T/abs_c2tv246l1c/croot/tk_1714770557340/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/opt/anaconda3/envs/mag-map=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /opt/anaconda3/envs/mag-map/include -mmacosx-version-min=11.1 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/opt/anaconda3/envs/mag-map/lib -L/opt/anaconda3/envs/mag-map/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/anaconda3/envs/mag-map/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/anaconda3/envs/mag-map/include'
...
TCL_PACKAGE_PATH='{/opt/anaconda3/envs/mag-map/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/anaconda3/envs/mag-map/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/opt/anaconda3/envs/mag-map/lib/libtclstub8.6.a'
