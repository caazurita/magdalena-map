...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/opt/anaconda3/envs/mag-map/bin',
 'BINLIBDEST': '/opt/anaconda3/envs/mag-map/lib/python3.10',
 ...
 'BLDSHARED': 'arm64-apple-darwin20.0.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/opt/anaconda3/envs/mag-map/lib '
              '-L/opt/anaconda3/envs/mag-map/lib '
              ''
              ''
              '-Wl,-pie -Wl,-headerpad_max_install_names '
              '-Wl,-dead_strip_dylibs '
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-isystem '
           '/opt/anaconda3/envs/mag-map/include '
           ' '
           ' '
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/opt/anaconda3/envs/mag-map/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-pie -Wl,-headerpad_max_install_names '
                      '-Wl,-dead_strip_dylibs '
 ...
 'CONFIG_ARGS': "'--prefix=/opt/anaconda3/envs/mag-map' "
                "'--build=arm64-apple-darwin20.0.0' "
                "'--host=arm64-apple-darwin20.0.0' '--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/opt/anaconda3/envs/mag-map/share/zoneinfo:/opt/anaconda3/envs/mag-map/share/tzinfo' "
                "'--with-computed-gotos' '--with-system-ffi' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/opt/anaconda3/envs/mag-map/include' "
                "'--with-tcltk-libs=-L/opt/anaconda3/envs/mag-map/lib "
                ...
                '-mmacosx-version-min=11.1 '
                "-I/opt/anaconda3/envs/mag-map/include' "
                "'PKG_CONFIG_PATH=/opt/anaconda3/envs/mag-map/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/opt/anaconda3/envs/mag-map/include',
 'CONFINCLUDEPY': '/opt/anaconda3/envs/mag-map/include/python3.10',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/opt/anaconda3/envs/mag-map '
             '/opt/anaconda3/envs/mag-map/lib '
             '/opt/anaconda3/envs/mag-map/lib/python3.10 '
             '/opt/anaconda3/envs/mag-map/lib/python3.10/lib-dynload',
 'DESTLIB': '/opt/anaconda3/envs/mag-map/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/opt/anaconda3/envs/mag-map/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/anaconda3/envs/mag-map/include '
                   '/opt/anaconda3/envs/mag-map/include '
                   '/opt/anaconda3/envs/mag-map/include/python3.10 '
                   '/opt/anaconda3/envs/mag-map/include/python3.10',
 'INCLUDEDIR': '/opt/anaconda3/envs/mag-map/include',
 'INCLUDEPY': '/opt/anaconda3/envs/mag-map/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/opt/anaconda3/envs/mag-map/lib/python3.10',
 'LIBDIR': '/opt/anaconda3/envs/mag-map/lib',
 'LIBFFI_INCLUDEDIR': '/opt/anaconda3/envs/mag-map/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/anaconda3/envs/mag-map/lib/pkgconfig',
 'LIBPL': '/opt/anaconda3/envs/mag-map/lib/python3.10/config-3.10-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/anaconda3/envs/mag-map/lib/python3.10',
 ...
 'MANDIR': '/opt/anaconda3/envs/mag-map/share/man',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/opt/anaconda3/envs/mag-map/include',
 'OPENSSL_LDFLAGS': '-L/opt/anaconda3/envs/mag-map/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/opt/anaconda3/envs/mag-map/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/opt/anaconda3/envs/mag-map/include',
 'TCLTK_LIBS': '-L/opt/anaconda3/envs/mag-map/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/opt/anaconda3/envs/mag-map/share/zoneinfo:/opt/anaconda3/envs/mag-map/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'datarootdir': '/opt/anaconda3/envs/mag-map/share',
 'exec_prefix': '/opt/anaconda3/envs/mag-map',
 'prefix': '/opt/anaconda3/envs/mag-map',
